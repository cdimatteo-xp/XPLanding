...
const Products = () => {
    return (
        <section id="sistemas" className="py-24 bg-slate-50 text-slate-900 relative overflow-hidden min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mt-8">
                ...
                <div className="text-center mb-20">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-100 text-blue-700 text-sm font-bold uppercase tracking-wide mb-6 border border-blue-200">
                        <Briefcase size={16} />
                        Software Corporativo
                    </div>

                    <p className="mt-2 text-4xl font-extrabold text-slate-900 sm:text-5xl tracking-tight">
                        Ecosistema de Gestión Crítica
                    </p>
                    <p className="mt-4 text-slate-600 text-xl max-w-3xl mx-auto">
                ...
                <div className="space-y-32">
                    ...
                    <div className="relative">
                        <div className="flex flex-col md:flex-row items-baseline gap-4 mb-8 border-b border-slate-200 pb-4">
                            <h3 className="text-3xl font-bold text-slate-900 flex items-center gap-3">
                                <span className="p-2 rounded-lg bg-lime-100 text-lime-600"><Shield size={32} /></span>
                                e-ACM.core <span className="text-slate-500 text-2xl font-normal">| Audit Control Manager</span>
                            </h3>
                            <p className="text-lime-600 font-medium ml-auto">Líder en Auditoría Continua</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
                            <div className="lg:col-span-4 flex flex-col justify-center">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 text-sm text-slate-600">
                                        <div className="w-8 h-8 rounded-full bg-lime-100 flex items-center justify-center text-lime-600 shrink-0"><Activity size={16}/></div>
                                        <span>Auditoría Continua (No Presencial)</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-sm text-slate-600">
                                        <div className="w-8 h-8 rounded-full bg-lime-100 flex items-center justify-center text-lime-600 shrink-0"><FolderOpenDot size={16}/></div>
                            ...
                            <div className="lg:col-span-8 space-y-4">
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-lime-500/50 transition group">
                                    <div className="bg-lime-100 p-4 rounded-lg flex items-center justify-center text-lime-600 w-16 h-16 shrink-0 group-hover:scale-110 transition-transform">
                                        <ClipboardCheck size={28} />
                                    </div>
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Estandarización Metodológica</h5>
                                ...
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-lime-500/50 transition group">
                                    ...
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Análisis de Datos & Control</h5>
                                        <p className="text-slate-600 text-sm mb-3">
                                ...
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-lime-500/50 transition group">
                                    ...
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Trazabilidad & Seguimiento</h5>
                                        <p className="text-slate-600 text-sm mb-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                            {[
                                ...
                                <div key={idx} className={`relative p-6 rounded-2xl border flex flex-col hover:transform hover:-translate-y-1 transition duration-300 ${plan.highlight ? 'border-lime-500 bg-lime-500/5 shadow-[0_0_30px_rgba(132,204,22,0.15)]' : 'border-slate-200 bg-white'} hover:border-lime-500/50`}>
                                    {plan.highlight && <div className="absolute top-0 right-0 bg-lime-600 text-slate-50 text-[10px] font-bold px-2 py-1 rounded-bl-lg rounded-tr-2xl">RECOMENDADO</div>}
                                    ...
                                    <div className="mt-6 pt-4 border-t border-slate-200/50 flex justify-end">
                                        <Link to="/contacto" className="flex items-center gap-1 text-slate-500 text-xs hover:text-slate-900 transition group">
                    ...
                    <div className="relative">
                        ...
                        <div className="flex flex-col md:flex-row items-baseline gap-4 mb-8 border-b border-slate-200 pb-4 relative z-10">
                            <h3 className="text-3xl font-bold text-slate-900 flex items-center gap-3">
                                <span className="p-2 rounded-lg bg-amber-100 text-amber-600"><AlertTriangle size={32} /></span>
                                e-ACR.core <span className="text-slate-500 text-2xl font-normal">| Suite de Riesgos</span>
                            </h3>
                            <p className="text-amber-600 font-medium ml-auto">Gestión Integral de Riesgos</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12 relative z-10">
                            <div className="lg:col-span-4 flex flex-col justify-center">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 text-sm text-slate-600">
                                        <div className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center text-amber-600 shrink-0"><Globe size={16}/></div>
                                        <span>Basilea II / III & ISO 27005</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-sm text-slate-600">
                                        <div className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center text-amber-600 shrink-0"><AlertTriangle size={16}/></div>
                                        <span>Matrices de Riesgo Dinámicas</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-sm text-slate-600">
                                        <div className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center text-amber-600 shrink-0"><Activity size={16}/></div>
                            ...
                            <div className="lg:col-span-8 space-y-4">
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-amber-500/50 transition group">
                                    <div className="bg-amber-100 p-4 rounded-lg flex items-center justify-center text-amber-600 w-16 h-16 shrink-0 group-hover:scale-110 transition-transform">
                                        <LayoutDashboard size={28} />
                                    </div>
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Mapa de Riesgos Unificado</h5>
                                        <p className="text-slate-600 text-sm mb-3">
                                ...
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-amber-500/50 transition group">
                                    ...
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Cumplimiento Normativo</h5>
                                        <p className="text-slate-600 text-sm mb-3">
                                ...
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-amber-500/50 transition group">
                                    ...
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Mitigación y Continuidad</h5>
                                        <p className="text-slate-600 text-sm mb-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={idx} className={`relative p-6 rounded-2xl border flex flex-col hover:transform hover:-translate-y-1 transition duration-300 ${plan.highlight ? 'border-amber-500 bg-amber-500/5 shadow-[0_0_30px_rgba(245,158,11,0.15)]' : 'border-slate-200 bg-white'} hover:border-amber-500/50`}>
                                    {plan.highlight && <div className="absolute top-0 right-0 bg-amber-600 text-slate-50 text-[10px] font-bold px-2 py-1 rounded-bl-lg rounded-tr-2xl">RECOMENDADO</div>}
                                    <h4 className="text-xl font-bold text-slate-900 mb-4">{plan.name}</h4>
                                    <ul className="space-y-3 flex-grow">
                                        {plan.features.map((f, i) => (
                                            <li key={i} className="flex items-start text-sm text-slate-600">
                    ...
                    {/* ========================================= */}
                    <div className="relative">
                        <div className="flex flex-col md:flex-row items-baseline gap-4 mb-10 border-b border-slate-200 pb-4">
                            <h3 className="text-3xl font-bold text-slate-900 flex items-center gap-3">
                                <span className="p-2 rounded-lg bg-cyan-100 text-cyan-600"><Lock size={32} /></span>
                                e-CML.core <span className="text-slate-500 text-2xl font-normal">| Control Money Laundry</span>
                            </h3>
                            <p className="text-cyan-600 font-medium ml-auto">Cumplimiento Normativo (PLA/FT)</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
                            <div className="lg:col-span-4 flex flex-col justify-center">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 text-sm text-slate-600">
                                        <div className="w-8 h-8 rounded-full bg-cyan-100 flex items-center justify-center text-cyan-600 shrink-0"><Globe size={16}/></div>
                                        <span>Normativa GAFI & UIF</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-sm text-slate-600">
                                        <div className="w-8 h-8 rounded-full bg-cyan-100 flex items-center justify-center text-cyan-600 shrink-0"><ScanFace size={16}/></div>
                                        <span>KYC Aumentado (360°)</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-sm text-slate-600">
                                        <div className="w-8 h-8 rounded-full bg-cyan-100 flex items-center justify-center text-cyan-600 shrink-0"><Activity size={16}/></div>
                            ...
                            <div className="lg:col-span-8 space-y-4">
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-cyan-500/50 transition group">
                                    <div className="bg-cyan-100 p-4 rounded-lg flex items-center justify-center text-cyan-600 w-16 h-16 shrink-0 group-hover:scale-110 transition-transform">
                                        <BrainCircuit size={28} />
                                    </div>
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Monitoreo Conductual (Behavioral)</h5>
                                        <p className="text-slate-600 text-sm mb-3">
                                ...
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-cyan-500/50 transition group">
                                    ...
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Gestión de Grupos Económicos</h5>
                                        <p className="text-slate-600 text-sm mb-3">
                                ...
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-cyan-500/50 transition group">
                                    ...
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Screening & Automatización</h5>
                                        <p className="text-slate-600 text-sm mb-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={idx} className={`relative p-6 rounded-2xl border flex flex-col hover:transform hover:-translate-y-1 transition duration-300 ${plan.highlight ? 'border-cyan-500 bg-cyan-500/5 shadow-[0_0_30px_rgba(6,182,212,0.15)]' : 'border-slate-200 bg-white'} hover:border-cyan-500/50`}>
                                    {plan.highlight && <div className="absolute top-0 right-0 bg-cyan-600 text-slate-50 text-[10px] font-bold px-2 py-1 rounded-bl-lg rounded-tr-2xl">RECOMENDADO</div>}
                                    <h4 className="text-xl font-bold text-slate-900 mb-4">{plan.name}</h4>
                                    <ul className="space-y-3 flex-grow">
                                        {plan.features.map((f, i) => (
                                            <li key={i} className="flex items-start text-sm text-slate-600">
                    ...
                    {/* ========================================= */}
                    <div className="relative">
                        <div className="flex flex-col md:flex-row items-baseline gap-4 mb-10 border-b border-slate-200 pb-4 relative z-10">
                            <h3 className="text-3xl font-bold text-slate-900 flex items-center gap-3">
                                <span className="p-2 rounded-lg bg-purple-100 text-purple-600"><Landmark size={32} /></span>
                                e-FIDUCIA.core <span className="text-slate-500 text-2xl font-normal">| Sistema Core Fiduciario</span>
                            </h3>
                            <p className="text-purple-600 font-medium ml-auto">Administración End-to-End</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
                            <div className="lg:col-span-4 flex flex-col justify-center">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 text-sm text-slate-600">
                                        <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 shrink-0"><ScanFace size={16}/></div>
                                        <span>Gestión de Prospects (Originación)</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-sm text-slate-600">
                                        <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 shrink-0"><Coins size={16}/></div>
                            ...
                            <div className="lg:col-span-8 space-y-4">
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-purple-500/50 transition group">
                                    <div className="bg-purple-100 p-4 rounded-lg flex items-center justify-center text-purple-600 w-16 h-16 shrink-0 group-hover:scale-110 transition-transform">
                                        <Briefcase size={28} />
                                    </div>
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Administración del Ciclo de Vida</h5>
                                        <p className="text-slate-600 text-sm mb-3">
                                ...
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-purple-500/50 transition group">
                                    ...
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Ingeniería Financiera y Deuda</h5>
                                        <p className="text-slate-600 text-sm mb-3">
                                ...
                                <div className="bg-white p-6 rounded-xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-purple-500/50 transition group">
                                    ...
                                    <div>
                                        <h5 className="text-lg font-bold text-slate-900 mb-2">Contabilidad Automática</h5>
                                        <p className="text-slate-600 text-sm mb-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                            {[
                                ...
                                <div key={idx} className={`relative p-6 rounded-2xl border flex flex-col hover:transform hover:-translate-y-1 transition duration-300 ${plan.highlight ? 'border-purple-500 bg-purple-500/5 shadow-[0_0_30px_rgba(168,85,247,0.15)]' : 'border-slate-200 bg-white'} hover:border-purple-500/50`}>
                                    {plan.highlight && <div className="absolute top-0 right-0 bg-purple-600 text-slate-50 text-[10px] font-bold px-2 py-1 rounded-bl-lg rounded-tr-2xl">RECOMENDADO</div>}
                                    <h4 className="text-xl font-bold text-slate-900 mb-4">{plan.name}</h4>
                                    <ul className="space-y-3 flex-grow">
                                        {plan.features.map((f, i) => (
                                            <li key={i} className="flex items-start text-sm text-slate-600">
                ...
                <div className="mt-24 text-center">
                    <Link to="/contacto" className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-bold rounded-full text-white bg-slate-900 hover:bg-slate-800 transition shadow-2xl hover:shadow-white/20 transform hover:-translate-y-1">
