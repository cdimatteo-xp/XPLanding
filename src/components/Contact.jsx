                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button type="submit" className="w-full bg-blue-600 text-white font-bold py-4 px-8 rounded-lg hover:bg-blue-700 transition transform hover:-translate-y-1 shadow-lg">
                                Enviar Mensaje
                            </button>
                        </form>
                    </div>
